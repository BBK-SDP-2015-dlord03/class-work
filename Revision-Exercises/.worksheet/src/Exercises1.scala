...
object Exercises1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(144); 
  println("Welcome to the Scala worksheet");$skip(56); 

  def getSquare(value: Int) =
    Math.pow(value, 2);System.out.println("""getSquare: (value: Int)Double""");$skip(25); ;
